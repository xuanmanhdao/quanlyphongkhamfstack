    ...
    <div class="container">
            ...
            <div class="image-wrap">
                <div class="image-item">
                    ...
                    <div class="post__text">
                        <h3><a href="" class="post__title-link">Sàng lọc ung thư phụ khoa :
                    ...
                    <div class="video__menu">
                        ...
                        <ul class="video-menu__list">
                            <li class="video-menu__item">
                                <img class="video-item__thumbail" src="https://img.youtube.com/vi/EWpd5y_Ohco/maxresdefault.jpg" alt="" onerror="this.onerror=null;this.src='./asset/img/quyenloikhachhang.jpg'" >
        ...
        <div class="message-container">
            ...
            <div class="message-logo">
                <div>
                    <img class="logo-image" src="https://benhvienphusanhanoi.com/wp-content/plugins/elementor/assets/images/placeholder.png" alt="Không thể hiển thị">
                </div>
